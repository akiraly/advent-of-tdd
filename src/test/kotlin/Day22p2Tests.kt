...
1,1,8~1,1,9
  ...
  test(""" Given the example snapshot input then the sum of other bricks to fall in chain reactions is 7""") {
    exampleSnapshotInput.sumOfOtherBricksToFallInChainReactions() shouldBe 7
  }

  test(""" Given the custom snapshot input then the sum of other bricks to fall in chain reactions is 98167""") {
    customSnapshotInput.sumOfOtherBricksToFallInChainReactions() shouldBe 98167
  }
})
